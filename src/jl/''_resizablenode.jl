...
export ''_resizablenode

"""
    ''_resizablenode(;kwargs...)
...
"""
function ''_resizablenode(; kwargs...)
        available_props = Symbol[:data, :selected]
        wild_props = Symbol[]
        return Component("''_resizablenode", "ResizableNode", "dash_flows", available_props, wild_props; kwargs...)
end
